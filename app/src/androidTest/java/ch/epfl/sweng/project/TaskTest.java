...
public class TaskTest {
    ...
    public void testConstructorWithAllParameters() {
        ...
        Task newTaskTest = new Task(nameTest, descriptionTest, locationTest, dueDate, durationTest, energyTest.toString(), listContributorsTest);
        ...
        assertEquals(dueDate, newTaskTest.getDueDate());
